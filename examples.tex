...
\marginpar{hay que centrar los labels del dibujo}We now prove that the path $L=x_{n-1}x_{n-2}\dots x_2x_1x_{0}x_{n-1}\dots x_3x_2$ is zero. Once again, if $P$ denotes the potential associated to the quiver, we have that $\partial_{x_0}(P)=x_{n-1}x_{n-2}\dots x_2x_1+cbd$ and $\partial_{x_1}(P)=x_{0}x_{n-1}\dots x_3x_2+cbd$. Therefore, the relations
\begin{align*}
