...
\end{equation}
\marginpar{\textcolor{red}{las ecuaciones también están mal numeradas}}The result now follows by equating \eqref{euler-ch1} and \eqref{euler-ch2} and solving for $n$.
\end{proof}
